...
class CitizensControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create citizen" do
    assert_difference("Citizen.count") do
      post citizens_url, params: { citizen: { bio: @citizen.bio, display_name: @citizen.display_name } }
    end
  ...
  test "should update citizen" do
    patch citizen_url(@citizen), params: { citizen: { bio: @citizen.bio, display_name: @citizen.display_name } }
